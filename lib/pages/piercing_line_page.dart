                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        const SizedBox(height: 16),
                        _BulletPoint('First candle is a strong red (bearish) candle'),
                        _BulletPoint('Second candle opens below the low of the first candle'),
                        _BulletPoint('Second candle closes above the midpoint of the first candle\'s body'),
